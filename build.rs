...
fn export_sparkle_public_key() {
    ...
    println!("cargo:rustc-env=TIDE_SPARKLE_PUBLIC_ED_KEY={value}");
}
...
fn embed_windows_resources() {
    ...
    // VERSIONINFO wants four numeric fields; Tide's version has three.
...
BEGIN
    ...
    BEGIN
        BLOCK "040904b0"
        BEGIN
            VALUE "CompanyName", "Tide\0"
            VALUE "FileDescription", "{description}\0"
            VALUE "FileVersion", "{package_version}\0"
            VALUE "InternalName", "tide\0"
            VALUE "OriginalFilename", "tide.exe\0"
            VALUE "ProductName", "Tide\0"
...
"#
    ...
    let script = out_dir.join("tide.rc");
