/** Config persistence — thin wrapper around configStore that wires the platform keychain (safeStorage shim) and preserves the existing public API. Lazily initialized on first access (NOT at import) so appDataDir() resolves correctly after startup's userData relocation. */

import * as safeStorage from '../platform/secrets.js';
import * as sessionsModule from './ipc-adjacent/sessions.js';
