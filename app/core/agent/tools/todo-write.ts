...
function sharedStore(): import('../../ipc-adjacent/sessionStore.js').SessionStore | null {
  try {
    const { getSessionStore } = require('../../ipc-adjacent/sessions.js') as typeof import('../../ipc-adjacent/sessions.js');
