(() => {
  ...
  const nativeSkyCall = globalThis.__tideSkyCall;
  const nativeWrite = globalThis.__tideWrite;
  const nativeEmitImage = globalThis.__tideEmitImage;
  const nativeSetResponseMeta = globalThis.__tideSetResponseMeta;
  const nativeScheduleTimer = globalThis.__tideScheduleTimer;
  const nativeClearTimer = globalThis.__tideClearTimer;
  const nativeRefreshTimer = globalThis.__tideRefreshTimer;
  const cwd = globalThis.__tideCwd;
  const homeDir = globalThis.__tideHomeDir;
  const tmpDir = globalThis.__tideTmpDir;
  delete globalThis.__tideSkyCall;
  delete globalThis.__tideWrite;
  delete globalThis.__tideEmitImage;
  delete globalThis.__tideSetResponseMeta;
  delete globalThis.__tideScheduleTimer;
  delete globalThis.__tideClearTimer;
  delete globalThis.__tideRefreshTimer;
  delete globalThis.__tideCwd;
  delete globalThis.__tideHomeDir;
  delete globalThis.__tideTmpDir;
  ...
  const timerId = Symbol("tide.timerId");
  const timerRefed = Symbol("tide.timerRefed");
  ...
  globalThis.__tideSetRequestMeta = (meta) => {
