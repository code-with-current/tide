/** Ported from upstream project (MIT, see THIRD_PARTY_NOTICES.md): packages/ui/src/components/chat/changedFilesPopover.ts. Verbatim; pure style constants, no Tide-specific adaptation needed. */
