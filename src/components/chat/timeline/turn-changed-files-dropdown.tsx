/** Ported from upstream project (MIT, see THIRD_PARTY_NOTICES.md): packages/ui/src/components/chat/TurnChangedFilesDropdown.tsx — ADAPTED.
 ...
 *  - Dropped: useDirectoryStore/useIsGitRepo/useUIStore (upstream stores). The git-repo
