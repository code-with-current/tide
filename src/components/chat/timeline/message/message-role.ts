...
export const deriveMessageRole = (
  messageInfo: TimelineMessage | (TimelineMessage & { clientRole?: string; userMessageMarker?: boolean }),
): MessageRoleInfo => {
  const info = messageInfo as TimelineMessage & { clientRole?: string; userMessageMarker?: boolean; origin?: string; source?: string };
