...
// katex base stylesheet — `.tide-chat .katex` overrides in chat-timeline.css
...
function ChatTimelineImpl({
  ...
  // following or scrolled up (the upstream's scrollToBottomOnSend).
  ...
  // Streaming tail: same ChatMessage-based renderMessage so live
  ...
  return (
    ...
    <div className="relative flex-1 min-h-0">
      ...
      >
        {/* `tide-chat` scopes the ported token layer (see
            chat-timeline.css) over every row in the timeline. */}
        <div className="tide-chat w-[80%] max-w-3xl mx-auto">
