...
const MarkdownImageThumbnail: React.FC<{
  ...
  return (
    <button
      ...
      onClick={openPreview}
      data-tide-markdown-image-action="true"
      data-tide-markdown-image-source={candidate.source}
      data-tide-markdown-image-filename={candidate.filename}
    >
      <span className="flex h-[72px] w-[100px] items-center justify-center overflow-hidden rounded-lg border border-border/40 bg-muted/10">
        {image.url && image.status !== 'error' ? (
          <img
            ...
            data-tide-markdown-image="true"
            data-tide-markdown-image-thumbnail="true"
            data-tide-markdown-image-state={image.status}
          />
        ) : (
      ...
      <span
        ...
        title={candidate.filename}
        data-tide-markdown-image-caption="true"
      >
...
export const MarkdownImageGallery: React.FC<{
  ...
  return (
    <div
      ...
      data-tide-markdown-image-gallery="true"
    >
