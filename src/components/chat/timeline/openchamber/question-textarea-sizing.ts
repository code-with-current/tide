/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/questionTextareaSizing.ts. Verbatim; pure logic, no Tide-specific adaptation needed. */
