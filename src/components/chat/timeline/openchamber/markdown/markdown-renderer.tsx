/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/MarkdownRenderer.tsx.
 *  Adaptation: `lazyWithChunkRecovery` (OpenChamber's retrying lazy loader) is
