/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/markdown/markdownCore.ts.
 *  Adaptation: OpenChamber app-link/agent/skill mention link handling
