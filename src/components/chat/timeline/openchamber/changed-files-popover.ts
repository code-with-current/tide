/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/changedFilesPopover.ts. Verbatim; pure style constants, no Tide-specific adaptation needed. */
