/**
 * Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/components/TurnItem.tsx.
...
const TurnItem: React.FC<TurnItemProps> = ({ turn, stickyUserHeader = true, renderMessage }) => {
  return (
    ...
    >
      {stickyUserHeader ? (
        <div className="oc-sticky-user-header sticky top-0 z-20 relative bg-[var(--surface-background)] [overflow-anchor:none]">
