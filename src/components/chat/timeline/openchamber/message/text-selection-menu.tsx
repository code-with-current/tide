/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/message/TextSelectionMenu.tsx.
 *  Adaptations (selection-tracking, positioning, drag handling, and markdown
 *  conversion ported verbatim):
 *  - OpenChamber store hooks (`useSessionUIStore`/`useSessions`/`useInputStore`/
