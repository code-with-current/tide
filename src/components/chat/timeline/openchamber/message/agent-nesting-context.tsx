 ...
 * Replaces OpenChamber's child-session model (`taskToolModel.ts` +
...
export interface AgentNestingContextValue {
  childPartsByToolCallId: Map<string, OcPart[]>;
}

const EMPTY_CHILD_PARTS = new Map<string, OcPart[]>();
...
// oxlint-disable-next-line react/only-export-components -- hook export beside the context object (leaf module, no fast-refresh concern)
export const useChildToolParts = (toolCallId: string | undefined): OcPart[] => {
