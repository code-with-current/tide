/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/message/ToolOutputDialog.tsx.
 *  Adaptations:
...
// ---------------------------------------------------------------------------
// Ruling-5 seam: minimal recursive disclosure tree replacing OpenChamber's
