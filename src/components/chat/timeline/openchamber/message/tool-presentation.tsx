/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/message/parts/toolPresentation.tsx.
 *  Adaptation: `Icon` comes from Tide's lucide shim (`../icon`) instead of
 *  OpenChamber's sprite-based `@/components/icon/Icon`; the upstream Remixicon
