/**
 * Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/message/parts/ToolPart.tsx.
 ...
 *   `lsp`, `openchamber*`, `create`/`file_write`/`view`/`cat` aliases.
 ...
 *   `../agent-nesting-context` — nested rows are real `OcPart`s rendered
...
import type { OcPart, OcToolPart, OcToolState } from '../../types/opencode-parts';
...
type ToolStateWithMetadata = OcToolState;
...
/** Local stand-in for OpenChamber's ui-kit `JsonTreeViewer` (T3-brief R5 mapping). */
...
const isToolPart = (part: OcPart): part is OcToolPart => part.type === 'tool';
