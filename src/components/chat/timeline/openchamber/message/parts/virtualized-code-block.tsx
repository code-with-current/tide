 ...
 *
 * Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/message/parts/VirtualizedCodeBlock.tsx.
...
import { useWorkerHighlightedLines } from '../../code/use-worker-highlighted-lines';
