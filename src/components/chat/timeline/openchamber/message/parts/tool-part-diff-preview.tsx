/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/message/parts/ToolPartDiffPreview.tsx.
 *  Adaptations:
 ...
 *    (`openchamber-md` via `ensureMarkdownShikiTheme`) plus a next-themes
