/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/QuestionCard.tsx — ADAPTED (Ruling 3).
 ...
 *  - Checkbox/Radio (OpenChamber ui) → shadcn adapters; RadioGroup uses index values so
