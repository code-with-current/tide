/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/DiffPreview.tsx.
 *  Adaptations:
 ...
 *    the --tools-edit-* / --md-syntax-* tokens Task 2 ported into openchamber-chat.css;
...
} from './markdown/markdown-syntax-vars';
import {
  useWorkerHighlightedLines,
  type WorkerHighlightedLinesResult,
} from './code/use-worker-highlighted-lines';
import { parseDiffToUnified } from './message/tool-renderers';
