/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/lib/turns/types.ts. `Message`/`Part` from '@opencode-ai/sdk/v2' replaced by the vendored OcMessage/OcPart types; no other changes. */
