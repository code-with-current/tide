/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/lib/turns/applyRetryOverlay.ts. `Message` from '@opencode-ai/sdk/v2' replaced by the vendored OcMessage type; no other changes. */
