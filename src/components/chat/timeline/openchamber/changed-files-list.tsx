/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/ChangedFilesList.tsx — ADAPTED.
 *  - `FileTypeIcon` (OpenChamber app component) → the ported ../icon shim's FileTypeIcon.
