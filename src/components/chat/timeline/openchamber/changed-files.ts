/** Ported from openchamber/openchamber (MIT): packages/ui/src/components/chat/changedFiles.ts — ADAPTED (Ruling 5).
...
export const extractChangedFiles = (parts: OcPart[]): ChangedFile[] => {
