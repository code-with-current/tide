              ...
              <div className="flex flex-wrap gap-1.5 mb-2">
                {chips.map((c, i) => (
                  <button
                    ...
                    className="inline-flex items-center gap-1 pl-1.5 pr-2 py-0.5 border text-[11px] font-mono rounded-md border-white/20 bg-white/10 text-white/85 max-w-[18rem] hover:bg-white/20 hover:border-white/40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/40 cursor-pointer transition-colors"
                  >
