...
import { VirtualizedFileDiff, areOptionsEqual, parseDiffFromFile } from '@pierre/diffs';
import type { FileDiffMetadata, FileDiffOptions, FileContents } from '@pierre/diffs';
 ...
 * PD3 wires this into the diff surfaces; nothing consumes it yet.
 */
