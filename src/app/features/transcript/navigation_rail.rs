...
pub(in crate::app) const NAVIGATION_RAIL_TICK_HEIGHT: f32 = 2.0;
const NAVIGATION_RAIL_TICK_GAP: f32 = 10.0;
const NAVIGATION_RAIL_INACTIVE_OPACITY: f32 = 0.45;
pub(in crate::app) const NAVIGATION_RAIL_TURN_HEIGHT: f32 =
...
pub(in crate::app) struct NavigationTurnOpening {
    pub message_index: usize,
    pub row_index: usize,
...
pub(in crate::app) fn navigation_turns(
...
#[derive(Clone, Debug)]
pub(in crate::app) struct ConversationNavigationRailSnapshot {
    pub visible: bool,
...
pub(in crate::app) struct ConversationNavigationRail {
    tide: Option<WeakEntity<Tide>>,
    pub(in crate::app) snapshot: ConversationNavigationRailSnapshot,
...
impl ConversationNavigationRail {
    ...
    pub(in crate::app) fn set_tide(&mut self, tide: WeakEntity<Tide>) {
        self.tide = Some(tide);
    }
