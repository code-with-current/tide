...
impl Tide {
    ...
    pub(in crate::app) fn render_inspector_session_section(
        &mut self,
        cx: &mut Context<Self>,
    ) -> Div {
    ...
    pub(in crate::app) fn render_inspector_config_section(
        &mut self,
        cx: &mut Context<Self>,
    ) -> Div {
        let theme = Theme::current(cx);
    ...
    pub(in crate::app) fn render_inspector_git_section(
        &mut self,
        cx: &mut Context<Self>,
    ) -> Option<Div> {
        let theme = Theme::current(cx);
...
impl Tide {
    ...
    /// has no log to show.
    pub(in crate::app) fn render_inspector_stream_log_section(
        &self,
        cx: &mut Context<Self>,
    ) -> Option<Div> {
        let theme = Theme::current(cx);
    ...
    /// frame.
    pub(in crate::app) fn render_inspector_actions_section(
        &mut self,
        cx: &mut Context<Self>,
    ) -> Option<Div> {
        let theme = Theme::current(cx);
    ...
    pub(in crate::app) fn render_inspector_memory_rag_section(
        &mut self,
        cx: &mut Context<Self>,
    ) -> Option<Div> {
        let theme = Theme::current(cx);
