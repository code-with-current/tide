...
pub(crate) use sections::{
    STREAM_LOG_CAP, StreamLogEntry, stream_log_entry, user_stream_log_entry,
};
...
impl Tide {
    ...
    /// docs/performance.md.
    pub(in crate::app) fn inspector_pane_content(
        &mut self,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ) -> AnyElement {
    ...
    pub(in crate::app) fn render_inspector(&mut self, cx: &mut Context<Self>) -> Div {
