...
impl Tide {
    ...
    pub(in crate::app) fn timeline_v2_refresh_search(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::app) fn timeline_v2_search_highlights(
        &self,
        message_index: usize,
    ...
    pub(in crate::app) fn render_timeline_v2_search_bar(
        &self,
        cx: &mut Context<Self>,
    ) -> Option<AnyElement> {
        let search = self.timeline_v2_state.search.as_ref()?;
