...
pub(crate) struct TranscriptV2 {
    ...
    /// fingerprint moves.
    pub navigation_turns: std::cell::RefCell<
        std::rc::Rc<
            Vec<crate::app::features::transcript::navigation_rail::TranscriptNavigationTurn>,
        >,
    >,
...
impl crate::app::Tide {
    ...
    pub(in crate::app) fn timeline_v2_remeasure_tail(&mut self, _cx: &mut gpui::Context<Self>) {
    ...
    pub(in crate::app) fn timeline_v2_scroll_to_navigation_turn(
        &mut self,
    ...
    pub(in crate::app) fn render_timeline_v2(
        &mut self,
