use crate::app::features::composer::visible_branch_entries;
use gpui::Focusable;
use gpui::prelude::*;
...
use crate::theme::sp;
use crate::ui::icon;
use crate::ui::menu::ConfirmEntry;
use crate::ui::menu::DismissMenu;
use crate::ui::menu::MenuAlign;
use crate::ui::menu::SelectNextEntry;
use crate::ui::menu::SelectPreviousEntry;
...
use crate::app::BRANCH_PICKER_ROW_HEIGHT;
use crate::app::BranchPickerAction;
use crate::app::BranchPickerMode;
...
pub(in crate::app) enum BranchPickerSurface {
    Composer,
    GitPanel,
}
...
/// the real checkout).
pub(in crate::app) struct BranchPickerContext {
...
impl Tide {
    ...
    pub(in crate::app) fn toggle_planned_worktree(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::app) fn begin_branch_creation(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::app) fn cancel_branch_creation(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::app) fn move_branch_picker_highlight(
        &mut self,
        key: &str,
    ...
    pub(in crate::app) fn confirm_branch_picker_action(
        &mut self,
        actions: &[BranchPickerAction],
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::app) fn render_branch_picker<E>(
        &mut self,
