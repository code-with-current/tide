...
pub(in crate::app) fn token_ranges(
    content: &str,
    tokens: &[String],
...
pub(in crate::app) enum ComposerSubmitAction {
    Send,
    Preparing,
    Stop,
}

pub(in crate::app) fn composer_submit_action(
...
impl Tide {
    ...
    pub(in crate::app) fn render_composer(&self, window: &Window, cx: &mut Context<Self>) -> Div {
