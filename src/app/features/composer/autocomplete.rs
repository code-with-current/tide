...
use super::next_picker_highlight;
...
pub(in crate::app) enum AutocompleteRow {
...
pub(in crate::app) struct AutocompleteUi {
...
impl AutocompleteUi {
    ...
    pub(in crate::app) fn card_bounds_cell(&self) -> Rc<Cell<Option<Bounds<Pixels>>>> {
...
impl Tide {
                    ...
                    let commands = cx
                        ...
                        .spawn(async move {
                            match workspace.request(
                                client::WorkspaceOperation::DiscoverSlashCommands {
                                    provider,
                                    project_root: path,
                                    binary_override: None,
                                },
                            ) {
                                Ok(client::WorkspaceResult::SlashCommands { commands }) => commands,
                                Ok(_) | Err(_) => Vec::new(),
                            }
                        })
                        .await;
            ...
            Query::Missing(token) => {
                ...
                cx.spawn(async move |tide, cx| {
                    let files = cx
                        .background_executor()
                        .spawn(async move {
                            match workspace.request(client::WorkspaceOperation::ListProjectFiles {
                                root: path,
                                cap: FILE_INDEX_CAP,
                            }) {
                                Ok(client::WorkspaceResult::ProjectFiles { entries }) => entries,
                                Ok(_) | Err(_) => Vec::new(),
                            }
                        })
                        .await;
    ...
    pub(in crate::app) fn move_autocomplete_highlight(
        &mut self,
        key: &str,
        window: &Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::app) fn accept_autocomplete(
        &mut self,
        index: Option<usize>,
        window: &Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::app) fn dismiss_autocomplete(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::app) fn render_composer_autocomplete(
        &self,
        window: &Window,
        cx: &mut Context<Self>,
...
pub(in crate::app) fn composer_card_bounds_probe(
