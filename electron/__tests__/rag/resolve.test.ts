...
vi.mock('../../rag/local-onnx-embedder.js', () => ({ LocalOnnxEmbedder: LocalMock }));
vi.mock('../../rag/cloud-embedder.js', () => ({ CloudEmbedder: CloudMock }));

import { resolveForBuild, resolveForQuery, ResolveError } from '../../rag/resolve.js';
