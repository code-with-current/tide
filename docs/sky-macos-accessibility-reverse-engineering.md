...
This is the critical path for Tide parity.
...
## Why Tide's previous approximation failed
...
## Compatibility requirements for Tide
...
1. Codex/Tide remains the actual frontmost application throughout.
