...
pub use quirk::{
    anthropic_call_options, budget_to_effort, clamp_tool_result_output, is_native_anthropic_host,
    openai_call_options, repair_json_tool_input, resolve_reasoning, ProtocolCallOptions,
    ProtocolContext, ReasoningInstruction, ReasoningOption, ThinkingLevel, DEFAULT_MAX_TOKENS,
    SSE_READ_TIMEOUT, TOOL_OUTPUT_FLOOR,
};
