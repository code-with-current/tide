...
//! Tide's shared, versioned wire contract.
//!
...
pub use protocol::{
    ...
    InitProgressWire, KnowledgeSourceWire, MAX_WIRE_MESSAGE_BYTES, PROTOCOL_VERSION,
    RagAffectedWorkspaceWire, RagConfigPatchWire, RagConfigWire, RagEndpointWire, RagModelWire,
    RagStatusWire, ReplayCursor, Request, ResponseOutcome, ResponsePayload, RpcError,
    SequencedEvent, ServerMessage, SourceProgressWire, WireComputerToolRequest, WireDriverEvent,
