...
//! `ccusage` do it, so usage covers turns driven outside Tide too. Costs are
...
pub use protocol::usage_history::{
...
mod tests {
    ...
    fn claude_lines_parse_usage_and_dedupe_key() {
        ...
        assert_eq!(record.project, "/Users/me/dev/tide");
    ...
    fn codex_lines_carry_model_forward_and_skip_duplicates() {
        ...
        let meta = r#"{"timestamp":"2026-08-06T16:31:19.166Z","type":"session_meta",
            "payload":{"id":"codex-session","cwd":"/Users/me/dev/tide"}}"#
            .replace('\n', " ");
    ...
    fn aggregation_dedupes_across_files_and_prices_records() {
        ...
        let record = UsageRecord {
            ...
            project: "/Users/me/dev/tide/crates/ui".to_owned(),
            totals: TokenTotals {
        ...
        let roots = [PathBuf::from("/Users/me/dev/tide")];
        ...
        assert_eq!(project.path, "/Users/me/dev/tide");
    ...
    fn rate_tables_parse_and_round_trip_through_the_disk_cache() {
        ...
        let dir = std::env::temp_dir().join(format!("tide-usage-rates-{}", std::process::id()));
