...
vi.mock('../../../electron/agent/system-model.js', () => ({ isRagCloudConfigured: isRagCloudConfiguredMock }));
vi.mock('../../../electron/rag/local-onnx-embedder.js', () => ({ LocalOnnxEmbedder: LocalMock, localModelExists: localModelExistsMock }));
vi.mock('../../../electron/rag/model-downloader.js', () => ({ downloadModel: downloadModelMock }));

import { getRagStatus, enableRagWorkspace, disableRagWorkspace, downloadRagModel } from '../../../electron/ipc/rag.js';
