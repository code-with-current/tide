...
3. Create the doc with write_file: title, description line, background, "Related" list (may be empty). Writing under the library root is permitted — Tide grants the library as a writable annex (the permission gate may ask for confirmation).
